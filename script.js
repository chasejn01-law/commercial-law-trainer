...
updateArticleLocks();
  ...
  const answers = [
    ...
    { id: "myInput12", answer: "parol evidence: extrinsic evidence can be used to supplement a partially integrated final writing. Contradictory terms are inadmissible. When a final writing is fully integrated, the parol evidence rule does not apply" },
    ...
    { id: "myInput22", answer: `risk of loss: if risk of loss has already passed from seller to buyer at the time the goods are destroyed or damaged, excuse doctrine does not apply and buyer must remit payment for the goods (no matter that they are compromised or no longer exist). When does risk of loss pass to the buyer? FOB seller’s place of business, passes once goods with carrier. FOB buyer’s place of business, passes when goods arrive at their specified destination. If goods in storage facility, passes when buyer receives documents of title` },
    ...
    { id: "myInput32", answer: `priority basic rules: first to perfect or file. Priority between two perfected parties, first to file. Perfected parties take priority over non-perfected parties. For unperfected parties, first to attach. Secured party v. lien creditor, first in time is first in right` },
    { id: "myInput33", answer: `default: completely a matter of contract. It is whatever the contract or security agreement says it is. Upon default, the secured party has two avenues for judicial enforcement: sue the debtor in court and get a money judgment for the amount of the debt or foreclose on the collateral, i.e., take possession of it and sell it. These rights are cumulative and can be exercised simultaneously  ` },
    ...
    { id: "myInput45", answer: `holder in due course: The requirements to be an HDC are, must be in possession of a negotiable instrument, must be a holder, no evidence of inauthenticity or obvious defects, and the HDC must give value (consideration) for the instrument` },
  ...
  { id: "bonusInput3", answer: "collateral: property subject to a security interest. Consumer goods are goods that are used or bought for use primarily for personal, family, or household purposes. Inventory is leased goods, goods for sale, raw materials, or materials used or consumed in business. Farm products are crops, livestock, supplies used or produced in a farming operation, etc. Equipment are any goods that are not consumer goods, inventory, or farm products and accounts are accounts receivable" },
  { id: "bonusInput4", answer: "secured party: a person in whose favor a security interest is created" },
  { id: "bonusInput5", answer: "debtor: a person having an interest, other than a security interest, in the collateral (usually owns it), whether or not the person is the obligor" },
